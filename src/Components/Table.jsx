...
function Table() {
    const baseUrl = "https://a8a3-2405-201-400c-488e-4447-2c3-5f26-dad6.ngrok-free.app";
                    ...
                    <tr>
                      ...
                      <td>
                        {data.favourite === true ? (
                          ...
                          <button onClick={HandleFavourite(data.favourite)}>{data.favourite === true}?Remove:Add to Favourite</button>
                        )}
                      </td>
                    </tr>
                  ) : (
